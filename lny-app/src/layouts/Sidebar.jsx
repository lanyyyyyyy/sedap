                ...
                <ul id="menu-list" className="space-y-3">
                    <li>
                        <NavLink id="menu-1" to="/" className={menuclass}>
                            <RxDashboard />Dashboard</NavLink>                   
                    </li>
                    <li>
                        <NavLink id="menu-2" to="/orders" className={menuclass}>
                            <HiOutlineShoppingCart />Orders</NavLink>
                    </li>
                    <li>
                        <NavLink id="menu-3" to="/customer" className={menuclass}>
                            <AiOutlineCustomerService />Customers</NavLink>
                    </li>
                </ul>
            </div>
            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card" className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center">
                    <div id="footer-text" className="text-white text-sm">
                        ...
                        <div id="add-menu-button" className="flex justify-center items-center p-2 mt-3 bg-gray-400">
                            <span>Add Menus</span>
                        </div>
                    </div>
